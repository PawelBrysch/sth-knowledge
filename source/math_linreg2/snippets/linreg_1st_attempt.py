...
#     io=os.path.abspath("../data/confoundOmitted_bigIntercept.xlsx"), header=0, usecols="C:E", nrows=80
# )
# df_density_small = pd.read_excel(
#     io=os.path.abspath("../data/nearlyPerfectlyCorrelatedConfoundOmitted_smallIntercept.xlsx"),
